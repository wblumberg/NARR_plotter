...
# happened on a certian day.
#
############################################

def regMap():
    '''
        This function makes a map using the Basemap object and matplotlib together.
        It draws the map coastlines, countries, states, and counties, and then returns
        the Basemap object so the program can draw additional things on the map (i.e. data)
    '''
    figure(figsize=(10,8))
...
def e2td(E):
    '''
        ...
        for some of the maps that gets plotted.
...
if type == 'svr':
    ...
    # Draw the dewpoint lines and lable them
...
try:
    ...
    # some dummy code I've left over...don't remember why
    """
    m = regMap()
